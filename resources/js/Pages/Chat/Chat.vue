...
<div>
    <div class="ui center container">
        <div class="ui segment inverted">
            <p><span class="ui huge text">{{channelDetails.channel_name}} </span></p>
        </div>
    </div> 
    <div id="chat_box" class="ui center container chat">
        <div v-for="(value, key) in channelMessages" :key="key" class="ui one column grid">
            <div class="row">
                <div class="left aligned left floated six wide column chat-box">
                    <div class="ui segment inverted">
                        <p><span class="ui medium text">{{value.from_user}}</span></p>
                    </div>
                    <div class="ui inverted segment green inverted">
                        <span>{{value.message}}</span>
                        <br>
                        <span class="ui small grey text">{{value.sent_at}}</span>
                    </div>
                </div>
            </div>
        </div>
